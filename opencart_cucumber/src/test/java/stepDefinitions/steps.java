...
public class steps {
    ...
    @Before //before starting each and every scenario not method. scenario is a collection of method
    public void setup(){
        //for logging, we can send logs messaging to logs
        logger= LogManager.getLogger(this.getClass());
        rb= ResourceBundle.getBundle("config");
        br=rb.getString("browser");
    }

    @After //before and after are called hook
